...
public class ClockView extends View {
    ...
    private void initClock() {
        height = getHeight();   // Edit this to change the ClockView size
        width = getWidth();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        drawCircle(canvas);     drawCenter(canvas);
        drawNumeral(canvas);    drawHands(canvas);
    ...
    // Draw all the hands on the clock
